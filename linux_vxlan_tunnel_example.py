...
def add_tunnel(args):
    ...
    with IPDB() as ipdb:
        ...
        with ipdb.create(kind='bridge',
            ...
            logger.info(f'vxlan{args.vni} and {args.physical_interface} added to br{args.vni}')
